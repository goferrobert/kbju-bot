...
- **Деплой:** Docker + Synology NAS DS925+
...
- Пошагово вводит данные: ФИО, дату рождения, пол, рост, вес, активность
- Бот рассчитывает процент жира и КБЖУ
- Отправляет персональные рекомендации

### 2. Повторный вход (зарегистрированный пользователь)
- При повторном запуске открывается главное меню
- Доступ к функциям: новые замеры, прогресс, цели
...
- **[TOKENS.md](TOKENS.md)** - Информация о токенах и безопасности
